...
export const tableData = [
  {
    ...
    description: "Create a local branchCreate a local branchCreate a local branchCreate a local branchCreate a local branchCreate a local branchCreate a local branchCreate a local branchCreate a local branchCreate a local branchCreate a local branch",
  },
  {
