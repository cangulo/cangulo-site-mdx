...
resources:
  - {
      type: code,
      title: AutoHotKey script to activate hotcoerners,
...
[Here](./resources/2020-08-02-setting-hot-corners-in-windows-10-with-autohoykey/hot-corners-w10.ahk) is the result file, we have to compile it to generate the `.exe` file, right-click on the `ahk` file and select _Compile Script)_. Click on the generated file to activate the hot corners. if you found it goes faster than you expected, keep the sleep lines I mention before.
